...
$('.misc-pub-section p').after('<a href="https://lucy.ne.jp/bazubu/how-to-set-scheduled-post-23756.html" target="_blank">予約投稿の設定方法</a>');
$('#category-add').after('<a href="https://lucy.ne.jp/bazubu/how-to-choose-seo-keywords-18458.html" target="_blank">キーワード選定とコンテンツプランニング</a>');
...
$(post_wrap_lp).before('<p class="inside"><small>リスト取得ページのタイトルを入力して下さい。ここに入力した内容がリスト取得ページのキャッチコピーとして表示されます。<br>キャッチコピーの内容によってコンバージョン率は変わります。『<a href="https://lucy.ne.jp/bazubu/catch7rules-29.html" target="_blank">反応率の高いキャッチコピーの作り方</a>』を参考にしましょう</small></p>');
...
$(post_wrap_cta).before('<p class="inside"><small>CTAのタイトルを入力して下さい。ここに入力された内容がCTAのキャッチコピーとして表示されます。<br>キャッチコピーの内容によってコンバージョン率は変わります。『<a href="https://lucy.ne.jp/bazubu/catch7rules-29.html" target="_blank">反応率の高いキャッチコピーの作り方</a>』を参考にしましょう</small></p>');
...
$( editor_before ).find("#postdivrich").before('<div id="editor-before" class="postbox"><h3 class="hndle">SEO効果を高める投稿方法</h3><div class="inside"><small>以下に本文を入力していきましょう。ユーザーに大きな価値を与える良質なコンテンツを作りましょう。コンテンツが良質でさえあれば、自然にSEOもソーシャルメディアも攻略することができます。また見出しの使い方や画像のALTタグの設定方法によってSEOの効果は変わってきます。『<a href="https://lucy.ne.jp/bazubu/contet-seo-18508.html" target="_blank">コンテンツSEOの効果と7つの手順</a>』と『<a href="https://lucy.ne.jp/bazubu/wordpress-post-3-15790.html" target="_blank">WordPressの投稿方法</a>』を参考にして下さい。</small></div></div>');
