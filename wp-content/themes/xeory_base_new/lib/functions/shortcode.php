...
EOF;
    ...
    <li class="bzb-twitter">
      <a href="https://x.com/share" class="twitter-share-button" data-url="{$page_url}"  data-text="{$post_title}">Tweet</a>
...
EOF;
    ...
    if($show_line_button){
      $line=<<<EOF
      <li class="bzb-line">
        <a href="https://line.me/R/msg/text/?{$post_title}%0D%0A{$page_url_encode}"><img src="{$line_image}" width="82" height="20" alt="LINEで送る" /></a>
      </li>
EOF;
    }
