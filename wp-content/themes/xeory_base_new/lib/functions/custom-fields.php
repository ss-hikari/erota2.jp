...
?>
  ...
  <h4>メタロボット</h4>
  <small>ページのnoindexやnofollowの設定を行います。詳しい使い方や効果は、『<a href="https://lucy.ne.jp/bazubu/seo101/how-to-use-noindex-tag" target="_blank">noindexの使い方</a>』や『<a href="https://lucy.ne.jp/bazubu/seo101/how-to-use-nofollow" target="_blank">nofollowの使い方</a>』をご覧下さい。</small>
  <ul>
    <li>
...
function bzb_post_layout() {
  ...
  $post_layout = get_post_meta($post->ID, 'bzb_post_layout', true) ? get_post_meta($post->ID, 'bzb_post_layout', true) : "left-content";
?>
...
function add_bzb_cta_button() {
  add_meta_box('bzb_cta_button', 'CTAで使用するボタンの設定a', 'bzb_cta_button', 'cta', 'normal', 'low');
}
